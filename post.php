...
?>
  ...
  <div class="related-posts">
   <h3>Related Posts</h3><hr>
    <div class="row">
      <?php
        $r_query = "SELECT * FROM posts WHERE status =
                            'publish' AND title LIKE '%$title%' LIMIT 3";
     ...
     <?php }
      ...
      if(isset($_POST['submit'])){
          ...
          if(empty($cs_name) or empty($cs_email) or empty($cs_comment)){
              ...
              $cs_query = "INSERT INTO `comments` (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES (NULL, '$cs_date', '$cs_name', 'user', '$post_id', '$cs_email', '$cs_website', 'unknown-picture2.jpg' , '$cs_comment' , 'pending')";
             ...
             <div class="col-xs-12">
                 <form action="" method="post">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" value="<?php if(isset($cs_website)){echo $cs_website;}?>" name="website" id="website" class="form-control" placeholder="Website Url" >
                     </div>
                     
                     <div class="form-group">
                         <label for="comment">Comment:*</label>
                          <textarea id="comment" name="comment" cols="30" rows="10" placeholder="Your comment sholud be here!" class="form-control"><?php if(isset($cs_comment)){echo $cs_comment;}?></textarea>
                     </div>
